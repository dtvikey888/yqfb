      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="15" style="background-color:#FFF">
          <tr>
			...
			<table width="100%" height="144" border="0" cellpadding="0" cellspacing="12" style="background-color:#FFF; font-family:微软雅黑; font-size:35px;">
          <tr>
            <td height="48" align="center" style="color:#888888; border-bottom:2px  solid  #f5f5f7 "><a style="font-family:Arial; font-size:20px;">NO.<%=bh%></a>&nbsp;<span style="font-family:Arial; font-size:20px;"></span></td>
          </tr>
         <tr>
            <td height="10" align="center" valign="middle"  style="color:#FFF;font-family:Arial; font-size:16px;"><table width="100%" border="0" cellspacing="10">
              <tr>
                <td width="39%" height="21"> 姓名(昵称)：</td>
                <td width="61%"><%=xm%></td>
              </tr>
              <tr>
                <td valign="top">拍摄时间:</td>
                <td valign="top"><%=pssj%></td>
              </tr>
              <tr>
                <td valign="top">拍摄地点：</td>
                <td valign="top"><%=psdd%></td>
              </tr>
          ...
          <tr>
            <td align="left" valign="middle" style="font-family:微软雅黑; font-size:16px; line-height:26px; "><div style="text-indent:2em;"><%=memo%><br/></div></td>
          </tr>
        </table></td>
      </tr>

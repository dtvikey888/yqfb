...
<html>
	...
	<link type="text/css" rel="stylesheet" href="../css/other11.css">
...
-->
   ...
   <div  id="contentid">
    <header>
            <div class="left-box">
                <a class="hd-lbtn" href="http://www.yqrb.com.cn/yqfb/ssp/index.jsp?openid=oSX6kjlwIvpFGl2Ws8TN5Ggxd7Ak"><span>返回</span></a>
            </div>
        <h1><font color="#000000">随手拍下不文明</h1>
    </header>
  ...
  <table width="120px;" height="100px;" border="0" cellpadding="0" cellspacing="0" style="border:3px dashed #F8B62D; font-family:Arial; font-size:12px; color:#dd1c60 ">
              <tr>
                <td align="center" valign="middle"><div><img id="imageList"  width="100px;" height="100px;" style="display:none"/>请上传清晰完整照、虚化照无效。
</div>
...
<div class="body p-10 address-edit" style="background:#efeff1">
      ...
      <tbody id="tbName">
      <tr>
        <td height="20"><input  id="xm" name="xm" type="text" class="input-common" placeholder="姓名(昵称)" pattern=".{2,}"  maxlength="10"  data-err="请正确填写姓名" value=""></td>
        </tr>
	  </tbody>
	...
	<tbody id="tbTitle">
      <tr>
        <td height="20"><input  id="title" name="title" type="text" class="input-common" placeholder="主题:请给照片拟个标题吧" pattern=".{2,}"  maxlength="50"  data-err="请正确填写主题" value=""></td>
        </tr>
	  </tbody>
	   -->
	 <tbody id="tbPssj">
      <tr>
        <td height="20"><input  id="pssj" name="pssj" type="text" class="input-common" placeholder="时间:请填写拍摄时间" pattern=".{2,}"  maxlength="20"  data-err="请正确填写拍摄时间" value=""></td>
        </tr>
	  </tbody>
	  
	 <tbody id="tbPsdd">
      <tr>
        <td height="20"><input  id="psdd" name="psdd" type="text" class="input-common" placeholder="地点:请填写拍摄地点" pattern=".{2,}"  maxlength="50"  data-err="请正确填写拍摄地点" value=""></td>
        </tr>
	  </tbody>
	    ...
	    <tbody id="tbMemo">
      <tr>
        <td height="20"><textarea id="memo" name="memo" class="text-common" placeholder="说明：请简单描述所拍摄图片的内容" pattern="^.{5,140}$"  maxlength="140"  data-err="请填写所拍摄图片的内容！"></textarea></td>
        </tr>
	  </tbody>
...
<span gaevent="imt/account/address/addBtn" class="btn btn-block" id="btn-login" );">这次名额已经没了报名结束！</span>
		...
		-->
          <div class="form-btn">
  <button type="submit" gaevent="imt/account/address/addBtn" class="btn2 btn-block2" id="btn-login" onClick="document.form1.action='sc_chk.jsp';if(DataLength(form1.file.value)<1){alert('请点击选取文件按钮选取图片');return false};if(DataLength(form1.xm.value)<2){alert('姓名最少2个字');form1.xm.focus();return false};if(DataLength(form1.tel.value)<2){alert('请填写正确手机号码');form1.tel.focus();return false};if(DataLength(form1.pssj.value)<2){alert('请填写拍摄时间');form1.pssj.focus();return false};if(DataLength(form1.psdd.value)<2){alert('请填写拍摄地点');form1.psdd.focus();return false};if(DataLength(form1.memo.value)<2){alert('请填写所拍摄图片的内容');form1.memo.focus();return false};document.form1.submit();">提交</button>
          </div>
          <!--
		end if%>
		-->          </td>

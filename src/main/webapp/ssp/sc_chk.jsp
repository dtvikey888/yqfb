...
System.out.println("原文件名： "+myFilemyFileName);
...
String pssj = mySmartUpload.getRequest().getParameter("pssj");
String psdd = mySmartUpload.getRequest().getParameter("psdd");
String memo = mySmartUpload.getRequest().getParameter("memo");
String bh = MyUtils8.GetNextBH();
System.out.println(xm);
System.out.println(tel);
//System.out.println(title);
System.out.println(pssj);
System.out.println(psdd);
System.out.println(memo);
System.out.println(bh);
 

//把图片和姓名电话写入数据库
int bz=WeixinChaOpenId.ReImgesToDB3(img1,xm,tel,pssj,psdd,memo,bh);

if(bz==2){
out.print("<script type=\"text/javascript\">alert('您的照片已经上传成功，编号"+bh+",请等待审核通过，召唤小伙伴一起参加吧！');document.location.href='index.jsp?openid="+openid+"';</script>");

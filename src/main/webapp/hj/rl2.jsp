...
<body>
	<% 
		...
		out.println("<script>window.location.href='http://www.yqrb.com.cn/CrestWs2/hj/rl.jsp?openid="+openid+"&ishd=1'</script>");
	...
	<%
			...
			out.println("<script>window.location.href='http://www.yqrb.com.cn/CrestWs2/hj/err.jsp?iscw=1'</script>");
	%>
</body>
</html>
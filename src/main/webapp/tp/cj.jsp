...
int t1 = MyUtils5.sy1(); //一等奖30元话费总数剩余名额
...
int day_sy1 = MyUtils5.TodaySY(1); //一等奖当天剩余名额
	  ...
	  %>
		...
		wx.ready(function(){
		 ...
		 // alert("开始");
		  ...
		  <%}else if(kz==2){
		    // 组装文本客服消息
		 //  String jsonTextMsg =AdvancedUtil.makeTextCustomMessage(openid, "非常抱歉，时间已过。感谢您的关注，请下次再来！");
		// 发送客服消息

...
<%
	//控制时间
	int kz =0;
	String tt1=AllValus.zmjs1;
	String tt2=AllValus.zmjs2;
...
if(twbsession!=null){
      ...
      if(twbsession.equals(openid)){
          ...
          //out.println("其他人点了以后，不回调");
           response.setHeader("Refresh","1;url=https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx86facd0a863aca12&redirect_uri=http%3a%2f%2fwww.yqrb.com.cn%2fyqfb%2fOAuthServlet19&response_type=code&scope=snsapi_base&state=1#wechat_redirect");        
...
<head>
    ...
    <title>最美教师评选</title>
    <meta name="description" content="微信投票-最美教师评选">
	...
	<script type="text/javascript">
		  ...
		  %>
            ...
            window.location.href="http://www.yqrb.com.cn/yqfb/tea/success.jsp";
...
<style type="text/css"> 
body{font-family:微软雅黑; padding:0px;margin:0px; background-color:#f4e6c3;}
*{margin:0;padding:0;}
...
if(ZghTools.IsCz8(openid)){

    yt=ZghTools.GetYt4(openid);

...
<% 
//String sql="select * from yqfbwx_tea order by bh asc";
String sql="select * from yqfbwx_tea order by ps desc";
...
<div style="text-indent:1em; padding-top:9px;"><a href="http://www.yqrb.com.cn/yqfb/show6.jsp?id=<%=id%>"><img src="<%=images2%>" height="160" width="130"/></a></div>
...
<div style="margin-top:20px;margin-left:25px;">乐清最美女教师网络投票络投票(总投票):  <%=MyUtils7.GetTeacherZps() %></div>

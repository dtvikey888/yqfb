  ...
  <tr>
    <td><table width="980" border="1" bordercolor="#f1f1f3" cellspacing="0" cellpadding="5" >
      ...
      <tr bgcolor="#C24354" height="35" style="font-family:'微软雅黑'; font-size:14px; color:#FFF;">
        <td width="607">&nbsp;&nbsp;文章标题</td>
        <td width="173" align="center">时间</td>
        <td width="162" align="center">图文阅读人数</td>
        </tr>
...
%>	
  ...
  <tr align="right"  class="biaoti">
    <td height="22" colspan="9" ><div align="right">第<%=intPage%>页/共<%=intPageCount%>页/<%=intRowCount %>条&nbsp;&nbsp;
          <%if(intPage>1){%>

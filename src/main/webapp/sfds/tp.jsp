...
<%
	//控制时间
	int kz =0;
	String tt1=AllValus.sf1;
	String tt2=AllValus.sf2;
...
if(twbsession!=null){
      ...
      if(twbsession.equals(openid)){
          ...
          //out.println("其他人点了以后，不回调");
           response.setHeader("Refresh","1;url=https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx86facd0a863aca12&redirect_uri=http%3a%2f%2fwww.yqrb.com.cn%2fyqfb%2fOAuthServlet21&response_type=code&scope=snsapi_base&state=1#wechat_redirect");        
...
<head>
    ...
    <meta name="description" content="第二届“中雁荡山杯”全国大书法作品大赛">
	...
	<script type="text/javascript">
		  ...
		  %>
            ...
            window.location.href="http://www.yqrb.com.cn/yqfb/sfds/success.jsp";
...
if(ZghTools.IsCz11(openid)){

    lb1=ZghTools.GetLB(openid,1);
    lb2=ZghTools.GetLB(openid,2);
    lb3=ZghTools.GetLB(openid,3);
    lb4=ZghTools.GetLB(openid,4);
...
int lb=1;
if(request.getParameter("lb")!=null&&request.getParameter("lb")!=""){
lb = new Integer(request.getParameter("lb"));
}else{
lb = 1;
}
...
<tr>
<%if (lb==1){%>
<td width="9%"><a href="?lb=1&openid=<%=openid%>"><img src="css/image/button/001.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=2&openid=<%=openid%>"><img src="css/image/button/02.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=3&openid=<%=openid%>"><img src="css/image/button/03.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=4&openid=<%=openid%>"><img src="css/image/button/04.png" width="98%" height="38"></a></td>
<%}else if (lb==2){%>
<td width="9%"><a href="?lb=1&openid=<%=openid%>"><img src="css/image/button/01.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=2&openid=<%=openid%>"><img src="css/image/button/002.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=3&openid=<%=openid%>"><img src="css/image/button/03.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=4&openid=<%=openid%>"><img src="css/image/button/04.png" width="98%" height="38"></a></td>
<%}else if (lb==3){%>
<td width="9%"><a href="?lb=1&openid=<%=openid%>"><img src="css/image/button/01.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=2&openid=<%=openid%>"><img src="css/image/button/02.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=3&openid=<%=openid%>"><img src="css/image/button/003.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=4&openid=<%=openid%>"><img src="css/image/button/04.png" width="98%" height="38"></a></td>
<%}else if (lb==4){%>
<td width="9%"><a href="?lb=1&openid=<%=openid%>"><img src="css/image/button/01.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=2&openid=<%=openid%>"><img src="css/image/button/02.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=3&openid=<%=openid%>"><img src="css/image/button/03.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=4&openid=<%=openid%>"><img src="css/image/button/004.png" width="98%" height="38"></a></td>
<%}else{%>
<td width="9%"><a href="?lb=1&openid=<%=openid%>"><img src="css/image/button/001.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=2&openid=<%=openid%>"><img src="css/image/button/02.png" width="98%" height="38"></a></td>
<td width="9%"><a href="?lb=3&openid=<%=openid%>"><img src="css/image/button/03.png" width="98%" height="38"></a></td>
...
switch (lb) {
case 1:
    sql="select * from yqcnwx_lcb where lb=1 order by id asc";
    break;
case 2:
    sql="select * from yqcnwx_lcb where lb=2 order by id asc";
    break;
case 3:
    sql="select * from yqcnwx_lcb where lb=3 order by id asc";
    break;
case 4:
    sql="select * from yqcnwx_lcb where lb=4 order by id asc";
    break;
default:
    sql="select * from yqcnwx_lcb where lb=1 order by id asc";
    break;
...
<div style="text-indent:1em; padding-top:9px;"><a href="http://www.yqrb.com.cn/yqfb/show7.jsp?lb=<%=lb%>&id=<%=id%>&openid=<%=openid%>"><img src="<%=images2%>" height="160" width="130"/></a></div>
...
<div style="margin-top:150px;"></div>
   ...
   <div class="xuanfu">
	 ...
	 <div onClick="javascript:window.open('http://www.yqrb.com.cn/yqfb/sfds/tp.jsp')">
	 <img src="css/image/button/tp.png" width=100% height=44>
	 </div>
	  -->
	 ...
	 <div class="main-right3"><a href="rul2.jsp"><img src="css/image/button/rule.png" width=100% height=44></a></div>
	 </div>

...
<html>
	<head>
	<title>请给参加“乐清最美笑脸大赛”的<%=xm%> <%=bh%>投票，有机会抽中100元奖品哦。</title>
          ...
          <tr>
            <td height="103" colspan="3" style="font-family:微软雅黑; font-size:35px; "><table width="100%" border="0" cellspacing="10">
              <tr>
                ...
                <td width="71%">第 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPM(id) %></a> 名</td>
              </tr>
              <tr>
                <td rowspan="2" valign="top">笑脸得票：</td>
                <td valign="top">共 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPS(id) %></a> 票</td>
              </tr>
              <tr>
                <td height="21" valign="top" style="color:#888888" >距离第一名还差  <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetJLFirstPS(id) %></a> 票，快去帮他拉票吧！</td>
              </tr>
            </table></td>
          </tr>
          <tr>

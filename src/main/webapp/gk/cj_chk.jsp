...
<%
  ...
  if(iscztel){
    ...
    out.println("<script>alert('手机号码重复');window.location.href='dl.jsp?openid=="+openid+"'</script>");
...
int t1 = MyUtils7.sy1(); //一等奖总数剩余名额
int t2 = MyUtils7.sy2(); //二等奖总数剩余名额
...
int day_sy1 = MyUtils7.TodaySY(1); //一等奖当天剩余名额
int day_sy2 = MyUtils7.TodaySY(2); //二等奖当天剩余名额

...
<%
	//控制时间
	int kz =0;
	String tt1=AllValus.ddmf1;
	String tt2=AllValus.ddmf2;
...
if(twbsession1!=null){
      ...
      if(twbsession1.equals(openid)){
          ...
          //out.println("其他人点了以后，不回调");
           response.setHeader("Refresh","1;url=https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx86facd0a863aca12&redirect_uri=http%3a%2f%2fwww.yqrb.com.cn%2fyqfb%2fOAuthServlet23&response_type=code&scope=snsapi_base&state=1#wechat_redirect");        
...
<head>
    ...
    <title>乐清市第四届道德模范点赞活动</title>
    <meta name="description" content="乐清市第四届道德模范点赞活动">
	...
	<script type="text/javascript">
		  ...
		  %>
            ...
            window.location.href="http://www.yqrb.com.cn/yqfb/ddmf/list.jsp";
		  ...
		  %>
           ...
           window.location.href="http://www.yqrb.com.cn/yqfb/ddmf/success.jsp";
...
<div id="mcover" onClick="weChat()" style="display: none;">
   ...
   <div id="mcover2" onClick="weChat2()" style="display: none;">
          <img src="css/image/button/tip16.png">
   </div>
...
<% 
String sql="select * from yqcnwx_ddmf order by bh asc";
...
<div style="text-indent:1em; padding-top:9px;"><a href="http://www.yqrb.com.cn/yqfb/show8.jsp?id=<%=id%>&openid=<%=openid%>"><img src="<%=images2%>" height="160" width="130"/></a></div>

<div style="padding-top:8px; font-size:13px;" align="center">
<%if(title2.equals("陈莹丽")) {%>
...
<a href="http://www.yqrb.com.cn/yqfb/show8.jsp?id=<%=id%>&openid=<%=openid%>">
<img src="css/image/button/jj.png" width="110px;" height="45px;"/>
</a>
</div>

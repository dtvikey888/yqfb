...
if(openid!=null){
    if(MyUtils24.iscz(openid)){
        //out.println("<script>alert('请先填写用户信息！');window.location.href='tj.jsp'</script>");
        out.println("<script>window.location.href='index.jsp?id="+id+"&id2="+id2+"&share=1&state=3&op="+openid+"'</script>");
    }
}
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="tj_chk.jsp">

...
<html>
	<head>
	<title>请给参加"柳川杯"歌手大赛网络人气奖投票的<%=title%>投票!</title>
          ...
          <tr>
            <td colspan="2" style="font-family:微软雅黑; font-size:35px; "><table width="100%" border="0" cellspacing="10">
              <tr>
                ...
                <td width="71%">第 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPM5(id) %></a> 名</td>
              </tr>
              <tr>
                <td rowspan="2" valign="top">票数差距：</td>
                <td valign="top">共 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPS5(id) %></a> 票</td>
              </tr>
              <tr>
                <td height="21" valign="top" style="color:#888888" >距离第一名还差  <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetJLFirstPS5(id)%></a> 票，快去帮TA拉票吧！</td>
              </tr>
            </table></td>
          </tr>

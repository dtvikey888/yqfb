...
int tp =new Integer(request.getParameter("lb"));
...
<%
  ...
  while(RS.next()){
	...
	if(img.length()>0 && !img.equals("no.gif") ){
		images3 = "http://v.yqcn.com/bmwj/asp/sxbook/download3/"+img;
	}
...
<html>
	<head>
	<title>请给参加第二届“中雁荡山杯”全国大书法作品大赛投票的<%=title%>投票!</title>
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="15" style="background-color:#FFF">
         ...
         <!--  
          ...
          <tr>
          <td align="center"><div onClick="javascript:window.open('http://www.yqrb.com.cn/yqfb/sfds/tp.jsp?openid=<%=openid%>&lb=<%=tp%>','_self')"><img src="images/back.png" width="100%"/></div></td>
          ...
          <tr>
            <td align="center" valign="middle" bgcolor="#FFCCCC"><div onClick="preimg()"><img src="<%=images3%>" width="100%"/></div></td>
          </tr>
         <!-- 
          <tr>

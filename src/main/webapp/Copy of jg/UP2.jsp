...
<table width="70%" height="10" border="0" align="center" cellspacing="30">
  ...
  <button onclick="return processForm(this.form);" type="submit" style="padding:5px 5px;border-radius:15px; background:#C62619; border:0px #555 solid; color:#fff; font-size:25px; font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;表&nbsp;&nbsp;&nbsp;&nbsp;</button>  

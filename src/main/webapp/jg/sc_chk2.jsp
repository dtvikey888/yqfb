...
//把图片和姓名电话写入数据库
	if(WeixinChaOpenId.ReImgesToDB10(video1,openid,lb,memo,story)){
	     if(lb.equals("1")){
	     	out.print("<script type=\"text/javascript\">alert('"+AllValus.title3_1+"');document.location.href='index.jsp?openid="+openid+"';</script>");
	     }else if(lb.equals("2")){
	     	out.print("<script type=\"text/javascript\">alert('"+AllValus.title3_2+"');document.location.href='index.jsp?openid="+openid+"';</script>");
	     }else if(lb.equals("3")){
	     	out.print("<script type=\"text/javascript\">alert('"+AllValus.title3_3+"');document.location.href='index.jsp?openid="+openid+"';</script>");
	     }else if(lb.equals("4")){
	     	out.print("<script type=\"text/javascript\">alert('"+AllValus.title3_4+"');document.location.href='index.jsp?openid="+openid+"';</script>");
	     }else{
	        out.print("<script type=\"text/javascript\">alert('"+AllValus.title4+"');document.location.href='index.jsp?openid="+openid+"';</script>");
	     }
...
// out.print("<script language=javascript>" + ret + "</script>");
  ...
  out.print("<script language=javascript>alert('文件超过80MB，请选择其他文件！');history.back();window.location.href=document.referrer;</script>");
 }  
 }  
 }catch (Exception e){

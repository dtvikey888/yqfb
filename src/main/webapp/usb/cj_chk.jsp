...
%>
 ...
 <%
 //这里开始提交用户数据
   int fhz = MyUtils6.StartCJBM(MyUtils2.codetoString(openid));
    //1 已经抽过奖(提交数据失败，然后关闭页面) 2.还没抽奖,留在本页面 就是抽奖页面.
  %>
...
<html>
	...
	*{margin:0;padding:0;list-style-type:none;}
	...
	//控制时间
	int kz =0;
	String cc1=AllValus.pp1;
	String cc2=AllValus.pp2;
    ...
    //3: //抽奖还没开始呢
	 ...
	 //中了什么奖
	 String zsm = MyUtils6.zsm(openid);
	  %>
...
int day_sy1 = MyUtils6.TodaySY(1); //一等奖当天剩余名额
   ...
   %>
		...
		wx.ready(function(){
		  ...
		  // String accessToken = WeixinChaOpenId.GetDBAccessToken(""+AllValus.memo+"");
		   ...
		   <% if(fhz==1){
		     // 组装文本客服消息
		  // String jsonTextMsg =AdvancedUtil.makeTextCustomMessage(openid, "您已经抽过奖，"+zsm+"");
		// 发送客服消息
		...
		function eventUp(e){  
			...
			if(j<=w*h*0.8){
                  ...
                  // alert(x);
                    ...
                    location.href="http://www.yqrb.com.cn/yqfb/usb/cj2.jsp?openid="+opp+"&zsm="+zj1+" ";

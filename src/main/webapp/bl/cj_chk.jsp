...
<%@page import="org.fjw.weixin.util.MyUtils21"%>
<%@page import="org.fjw.weixin.util.AllValus"%>
<%@page import="org.fjw.weixin.util.MathRandom5"%>
<%

String openid = request.getParameter("openid");
String urlname = "bl/cj_chk.jsp";
...
%>
 ...
 <%
    //这里开始提交用户数据
    MyUtils21.StartCJBM(MyUtils2.codetoString(openid),xm,MyUtils2.codetoString(tel),lx);
...
<html>
	...
	*{margin:0;padding:0;list-style-type:none;}
	...
	//控制时间
	int kz =0;
	String cc1=AllValus.amst1;
	String cc2=AllValus.amst2;
...
int t1 = MyUtils21.sy1(); //一等奖总数剩余名额
int t2 = MyUtils21.sy2(); //二等奖总数剩余名额
int t3 = MyUtils21.sy3(); //三等奖总数剩余名额
int t4 = MyUtils21.sy4();
int t5 = MyUtils21.sy5();
int t6 = MyUtils21.sy6();
int t7 = MyUtils21.sy7();
int t8 = MyUtils21.sy8();
int t9 = MyUtils21.sy9();
int t10 = MyUtils21.sy10();
int t11 = MyUtils21.sy11();
...
int day_sy1 = MyUtils21.TodaySY(1); //一等奖当天剩余名额
int day_sy2 = MyUtils21.TodaySY(2); //二等奖当天剩余名额
int day_sy3 = MyUtils21.TodaySY(3); //三等奖当天剩余名额
int day_sy4 = MyUtils21.TodaySY(4);
int day_sy5 = MyUtils21.TodaySY(5);
int day_sy6 = MyUtils21.TodaySY(6);
int day_sy7 = MyUtils21.TodaySY(7);
int day_sy8 = MyUtils21.TodaySY(8);
int day_sy9 = MyUtils21.TodaySY(9);
int day_sy10 = MyUtils21.TodaySY(10);
int day_sy11 = MyUtils21.TodaySY(11);
...
// 2.2 监听页面 body onload、获取“批量隐藏菜单项 ”
  ...
  <input type="hidden" name="day_sy7" id="day_sy7" value="<%=day_sy7%>">
  <input type="hidden" name="day_sy8" id="day_sy8" value="<%=day_sy8%>">
  <input type="hidden" name="day_sy9" id="day_sy9" value="<%=day_sy9%>">
  <input type="hidden" name="day_sy10" id="day_sy10" value="<%=day_sy10%>">
  <input type="hidden" name="day_sy11" id="day_sy11" value="<%=day_sy11%>">
...
var imgSrc = ['img/z_1.jpg','img/z_2.jpg','img/z_3.jpg','img/z_4.jpg','img/z_5.jpg','img/z_6.jpg','img/z_7.jpg','img/z_8.jpg','img/z_9.jpg','img/z_10.jpg','img/z_11.jpg','img/z_12.jpg'];
...
var day_sy6 = document.getElementById("day_sy6").value;
var day_sy7 = document.getElementById("day_sy7").value;
var day_sy8 = document.getElementById("day_sy8").value;
var day_sy9 = document.getElementById("day_sy9").value;
var day_sy10 = document.getElementById("day_sy10").value;
var day_sy11 = document.getElementById("day_sy11").value;
		...
		function eventUp(e){  
			...
			if(j<=w*h*0.9){
                  ...
                  // alert(x);
                    ...
                    location.href="http://www.yqrb.com.cn/yqfb/bl/cj2.jsp?tel=<%=tel%>&openid="+opp+"&zsm="+zj1+" ";

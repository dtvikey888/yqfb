...
<html>
    ...
    //3: //抽奖还没开始呢
	 ...
	 %>
	  ...
	  <%
	 //是否已经抽奖
	 //boolean iscj = MyUtils21.iscj_pd3(tel);
    ...
    return intLength 
		...
		// 发送客服消息
		 //  AdvancedUtil.sendCustomMessage(accessToken, jsonTextMsg);
		   ...
		   %>
		        ...
		        alert('全部奖品已抽完,感谢您对\"中国乐清网\"的关注，请下次再来！');
                //关闭当前网页窗口接口
                wx.closeWindow();
		...
		// 发送客服消息
		  ...
		  %>
            ...
            alert('非常抱歉，抽奖时间已过。感谢您对\"中国乐清网\"的关注，请下次再来！');
            //关闭当前网页窗口接口
            wx.closeWindow();
	 ...
	 <tbody id="tbName">
      <tr>
        <td height="20" bgcolor="#FFFFFF">
			...
			<select name="lx"  class="select-common">
			 <option value="" selected>选择运营商</option>

...
%>
 ...
 <%
 //这里开始提交用户数据
   int fhz = MyUtils21.StartCJLR2(tel,MyUtils2.codetoString(openid),MyUtils2.codetoString(zsm));
  ...
  %>
   ...
   <%
	 ...
	 //中了什么奖
	 String zsm22 = MyUtils21.zsm(openid);
	  %>

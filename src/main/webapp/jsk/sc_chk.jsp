...
System.out.println("sc openid:"+openid);
...
String fileName2="",ext="",testvar=""; 
 ...
 window.location='dl.jsp?openid=<%=openid%>'; 
 </script>
 <% 
  }  
  try{
...
//把压缩后的图片和姓名电话写入数据库
WeixinChaOpenId.ReImgesToDB4(img2,openid,tel);
...
//}else if(bz==1){
out.print("<script type=\"text/javascript\">alert('您的光盘照片上传成功，进入抽奖！');document.location.href='cjym.jsp?openid="+openid+"&tel="+tel+"&img1="+img2+"&memo="+memo+"';</script>");

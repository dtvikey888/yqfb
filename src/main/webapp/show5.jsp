...
<%
  ...
  String sql = "Select * FROM yqcnwx_twb where id="+id;
...
#menu2 { bottom:0; left:0; width:100%; position:fixed; padding:30px; text-align:center; background:#fff; z-index:2; }
   ...
   <div><img src="images/logo126.jpg" style="width:100%"/></div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="20">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="15" style="background-color:#FFF">
          ...
          <tr>
            <td colspan="2" style="font-family:微软雅黑; font-size:35px; "><table width="100%" border="0" cellspacing="10">
              <tr>
                ...
                <td width="71%">第 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPM4(id) %></a> 名</td>
              </tr>
              <tr>
                <td rowspan="2" valign="top">票数：</td>
                <td valign="top">共 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPS4(id) %></a> 票</td>
              </tr>
              <!-- 
              <tr>
          ...
          <tr>
          <td align="center"><div onClick="javascript:window.open('http://www.yqrb.com.cn/yqfb/twb/tp.jsp?openid=<%=openid%>','_self')"><img src="images/back.png" width="100%"/></div></td>
          ...
          <tr>
            <td colspan="2" align="center" valign="middle"><img src="images/zy4.png" width="100%"/></td>
          </tr>
          </table>

...
<%
  ...
  String sql = "Select * FROM yqfbwx_whlt where id="+id;
...
<html>
	<head>
	<title>请给参加乐清市首届最美文化礼堂系列评选的<%=title%>投票，万元话费等你拿!</title>
          ...
          <tr>
            <td colspan="2" style="font-family:微软雅黑; font-size:35px; "><table width="100%" border="0" cellspacing="10">
              <tr>
                ...
                <td width="71%">第 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPM2(id,lbs) %></a> 名</td>
              </tr>
              <tr>
                <td rowspan="2" valign="top">票数差距：</td>
                <td valign="top">共 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPS2(id,lbs) %></a> 票</td>
              </tr>
              <tr>
                <td height="21" valign="top" style="color:#888888" >距离第一名还差  <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetJLFirstPS2(id,lbs)%></a> 票，快去帮TA拉票吧！</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td align="center"><div onClick="javascript:window.open('http://v.yqcn.com/bmwj/baohu/tp_list.asp?openid=<%=openid%>','_self')"><img src="images/back.png" width="100%"/></div></td>

...
<%
    //这里开始提交用户数据
    int bz = MyUtils27.StartCJBM(openid,xm,tel,bh);
...
<head>
    ...
    <%
        //控制时间
        int kz =0;
        String cc1=AllValus.zb_t1;
        String cc2=AllValus.zb_t2;
    ...
    <%
        ...
        //中了什么奖
        // String zsm = MyUtils27.zsm(openid);
    %>
...
//System.out.println(t5);
    ...
    <%
        ...
        int day_sy1 = MyUtils27.TodaySY(1); //一等奖当天剩余名额
        int day_sy2 = MyUtils27.TodaySY(2); //二等奖当天剩余名额
        int day_sy3 = MyUtils27.TodaySY(3); //三等奖当天剩余名额
        int day_sy4 = MyUtils27.TodaySY(4);
//int day_sy5 = MyUtils27.TodaySY(5);

...
<%
  ...
  String sql = "Select * FROM yqcnwx_ddmf where id="+id;
...
<html>
	<head>
	<title>请给参加乐清市第四届道德模范点赞活动的<%=title%>投票!</title>
...
#menu2 { bottom:0; left:0; width:100%; position:fixed; padding:30px; text-align:center; background:#fff; z-index:2; }
   ...
   <div>《<img src="images/logo13.jpg" style="width:100%"/></div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="20">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="15" style="background-color:#FFF">
          ...
          <tr>
            <td colspan="2" align="center" style="color:#888888; border-bottom:2px  solid  #f5f5f7 "><a style="font-family:Arial;font-size:20px;color:#dd1c60;">NO.<%=bh%></a>&nbsp;
            <span style="font-family:Arial; font-size:20px;">
            
<%if(title.equals("陈莹丽")) {%>
<div style="border:1px solid #000;width:25%;">
<%=title%>
</div>
<%} else{%>
<%=title%>
<%} %>
          ...
          <tr>
            <td colspan="2" style="font-family:微软雅黑; font-size:35px; "><table width="100%" border="0" cellspacing="10">
              <tr>
                ...
                <td width="71%">第 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPM7(id) %></a> 名</td>
              </tr>
              <tr>
                <td rowspan="2" valign="top">票数：</td>
                <td valign="top">共 <a  style="font-family:Arial; color:#dd1c60;"><%=MyUtils3.GetPS7(id) %></a> 票</td>
              </tr>
              <!-- 
              <tr>
                <td height="21" valign="top" style="color:#888888" >距离第一名还差  <a  style="font-family:Arial; color:#dd1c60;"><=MyUtils3.GetJLFirstPS4(id)%></a> 票，快去帮TA拉票吧！</td>
              </tr> -->
            </table></td>
          </tr>
          
          <tr>
            <td align="center"><div onClick="javascript:window.open('http://www.yqrb.com.cn/yqfb/ddmf/tp.jsp?openid=<%=openid%>','_self')"><img src="images/back.png" width="100%"/></div></td>
          ...
          <tr>
            <td colspan="2" align="center" valign="middle"><img src="images/zy5.png" width="100%"/></td>
          </tr>
          </table>
          ...
          <tr>
            <td align="left" valign="middle" style="font-family:微软雅黑; font-size:16px; line-height:26px; ">
            
            <br/>

            <div style="text-indent:2em;padding-left:4px; padding-right:4px;">

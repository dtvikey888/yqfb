 ...
 */
public class OAuthServlet35 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet35.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("bl7/hd3.jsp").forward(request, response);
	}
}
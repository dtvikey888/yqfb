 ...
 * @date 2013-11-12
 * 授权网址
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx86facd0a863aca12&redirect_uri=http%3a%2f%2fwww.yqrb.com.cn%2fyqfb%2fOAuthServlet3&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
 */
public class OAuthServlet11 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("dj/rl2.jsp?bzlopenid="+state+"").forward(request, response);
	}
}
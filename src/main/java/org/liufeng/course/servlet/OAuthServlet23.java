 ...
 */
public class OAuthServlet23 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet23.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("ddmf/rl.jsp").forward(request, response);
	}
}
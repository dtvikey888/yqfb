 ...
 */
public class OAuthServlet21 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet21.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("sfds/rl.jsp").forward(request, response);
	}
}

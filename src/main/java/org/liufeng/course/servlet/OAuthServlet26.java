 ...
 */
public class OAuthServlet26 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet26.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("jg/rl3.jsp").forward(request, response);
	}
}
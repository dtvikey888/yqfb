 ...
 */
public class OAuthServlet20 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet20.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("tea/rl2.jsp").forward(request, response);
	}
}

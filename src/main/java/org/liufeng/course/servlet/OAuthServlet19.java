 ...
 */
public class OAuthServlet19 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet19.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("tea/rl.jsp").forward(request, response);
	}
}
 ...
 */
public class OAuthServlet15 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet15.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("lyzx/hd.jsp?bzlopenid="+state+"").forward(request, response);
	}
}
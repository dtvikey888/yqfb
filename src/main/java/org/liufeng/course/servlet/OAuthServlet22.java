 ...
 */
public class OAuthServlet22 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet22.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("doc/rl.jsp").forward(request, response);
	}
}

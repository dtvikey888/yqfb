 ...
 */
public class OAuthServlet18 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("OAuthServlet18.doGet() code= "+code);
		...
		// 跳转到index.jsp
		request.getRequestDispatcher("lcb/rl.jsp").forward(request, response);
	}
}